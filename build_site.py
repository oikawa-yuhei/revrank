...
GENRE_META = {
    "running_shoes": {"slug":"running-shoes","label":"ランニングシューズ","emoji":"👟",
        ...
        "guide":"選ぶ視点は「足幅」「ドロップ高」「クッション素材」の3点。同じサイズでもメーカーによって足幅の設計は大きく異なる。楽天の売れ筋はセール品やキャンペーン商品が上位に入りやすいが、RevRankは評価点と件数をベイズ統計で補正したスコアで並べ直す。レビューが少ない商品はスコアがジャンル平均に引き寄せられる設計なので、少数の高評価より多くの購入者から安定して評価された一足が上位に残る。",
    ...
    "running_watch": {"slug":"running-watch","label":"ランニングウォッチ・GPS","emoji":"⌚",
        ...
        "guide":"GPS精度・バッテリー持ち・心拍計の精度が三大比較ポイント。スマートウォッチと兼用するか、ランニング特化にするかで選択肢が変わる。RevRankは楽天の購入者評価点と件数をベイズ補正したスコアで並べる。件数の少ない新モデルはスコアがジャンル平均付近に落ち着くため、実際に多くのランナーから継続的に高評価を得た製品が上位に浮かび上がる構造だ。",
    ...
    "golf_club": {"slug":"golf-club","label":"ゴルフクラブ","emoji":"⛳",
        ...
        "guide":"クラブ選びで最も個人差が出るのがシャフトの硬さ（フレックス）と重量。スイングスピードに合わないシャフトは飛距離ロスに直結する。楽天の売れ筋は入門者向けセットが上位に入りやすいが、RevRankは評価点と件数をベイズ補正したスコアで順位を決める。試打できないネット購入だからこそ、多くのゴルファーから継続的に高評価を得ているかどうかが、信頼できる選択軸になる。",
    ...
    "golf_ball": {"slug":"golf-ball","label":"ゴルフボール","emoji":"⛳",
        ...
        "guide":"スピン量・飛距離・フィーリングの三軸で選ぶのが基本。アマチュアはディスタンス系から、スコアが安定してきたらスピン系への移行が定番。RevRankは楽天購入者の評価点と件数をベイズ補正したスコアで並べる。少数レビューは平均に引き寄せられるため、多くのゴルファーから安定して高評価を受けた製品が上位に残る。ブランド知名度より実際の評価の積み上がりで選べる。",
        "related":["golf_club","golf_shoes"]},
    "golf_shoes": {"slug":"golf-shoes","label":"ゴルフシューズ","emoji":"⛳",
        "kw":"ゴルフシューズ おすすめ",
        "desc":"ゴルフシューズの口コミ評価ランキング。実際のゴルファーから高評価を得た一足。",
        "guide":"18ホールを4〜5時間歩き続ける道具だからこそ「快適さの持続性」が最重要。防水性・グリップ力は雨のラウンドで真価が問われる。RevRankは評価点と件数をベイズ補正したスコアで順位を決める。見た目の良さより、複数ラウンドを経験した購入者から継続的に高評価を受けているかどうかを判断軸にしている。",
    ...
    "golf_bag": {"slug":"golf-bag","label":"ゴルフバッグ","emoji":"⛳",
        ...
        "guide":"収納力・重量・耐久性の三点が購入後の満足度を決める。スタンド型かカートバッグかで用途が分かれる。チャックの耐久性やポケットの使いやすさは使い込まないとわからない要素だが、RevRankは評価点と件数を統計補正したスコアで並べるため、多くの購入者から安定して高評価を得た製品が自然と上位に浮かび上がる。",
        "related":["golf_club","golf_shoes"]},
    "treadmill": {"slug":"treadmill","label":"ランニングマシン","emoji":"🏃",
        "kw":"ランニングマシン おすすめ 家庭用",
        "desc":"家庭用ランニングマシンの口コミ評価ランキング。静音性・折りたたみなど実用性を購入者が評価。",
        "guide":"家庭用ランニングマシンで見落とされがちなのが「騒音」と「振動の階下への影響」。スペック上の最大速度より、日常使いする速度域での静粛性の方が継続使用に直結する。RevRankは購入者の評価点と件数をベイズ補正で順位付けする。「買ったけど使わなくなった」という評価は星に反映されるため、多くの購入者から安定して高評価を受けている製品が上位に残りやすい。",
    ...
    "fitness_bike": {"slug":"fitness-bike","label":"フィットネスバイク","emoji":"🚴",
        ...
        "guide":"負荷調整のなめらかさ・シート高の調整範囲・ペダルの回転の滑らかさが選択の核心。テレワーク中のながら運動として使うなら静音性が最優先。RevRankは評価点と件数のベイズ補正スコアで並べる。購入直後の高評価より、一定期間使い続けた購入者が多いほどスコアの信頼性が上がるため、件数が積み上がった製品ほど実態を反映した順位になる。",
        "related":["treadmill","stepper"]},
    "stepper": {"slug":"stepper","label":"ステッパー","emoji":"🏋️",
        "kw":"ステッパー おすすめ ながら運動",
        "desc":"ステッパーの口コミ評価ランキング。テレワーク中の運動不足解消に人気の製品を実際の口コミで比較。",
        "guide":"毎日踏み続けるからこそ「安定性」と「耐久性」が命。安価なモデルは数ヶ月でガタつきが出ることも多い。RevRankは楽天購入者の評価点と件数をベイズ補正したスコアで順位を決める。レビュー件数が少ない商品はスコアがジャンル平均に引き寄せられる仕組みのため、多くの購入者から継続して高評価を受けた製品だけが上位に定着する。",
    ...
    "dumbbell": {"slug":"dumbbell","label":"ダンベル","emoji":"🏋️",
        ...
        "guide":"可変式か固定式かで用途が変わる。可変式は省スペースで複数の重量に対応できる反面、重量変更の操作性がトレーニングのテンポに影響する。グリップのローレット加工・プレートのズレにくさ・重量精度がホームジム派の関心ポイント。RevRankは評価点と件数をベイズ補正したスコアで並べるため、一時的な話題性ではなく多くの購入者から安定して高評価を受けた製品が上位に来る。",
        "related":["barbell","kettlebell"]},
    "barbell": {"slug":"barbell","label":"バーベル","emoji":"🏋️",
        "kw":"バーベル おすすめ セット",
        "desc":"バーベルセットの口コミ評価ランキング。ホームジム構築に実際に購入して高評価をつけた製品を厳選。",
        "guide":"シャフトのしなり（whip）・スリーブの回転・重量精度の三点が本格派の評価基準。安全性に直結する器具だからこそ、多くの購入者から継続的に高評価を受けているかどうかが重要な選択軸になる。RevRankは評価点と件数のベイズ補正スコアで順位を決めるため、楽天の低価格セット偏重の売れ筋とは異なる評価になることが多い。",
        "related":["dumbbell","kettlebell"]},
    "kettlebell": {"slug":"kettlebell","label":"ケトルベル","emoji":"🏋️",
        "kw":"ケトルベル おすすめ 重さ",
        "desc":"ケトルベルの口コミ評価ランキング。重量・素材・グリップを購入者が評価した製品を比較。",
        "guide":"シンプルな道具だからこそ「仕上げ」「底面の平坦さ」「ハンドルの太さと面粗さ」が品質差を生む。RevRankは評価点と件数をベイズ補正したスコアで順位付けする。レビューが少ない商品はスコアがジャンル平均に収束するため、多くの購入者から安定して高評価を受けた製品だけが上位に残る。塗装・重量精度に問題のある製品は評価点に反映されやすく、自然と順位が下がる。",
        "related":["dumbbell","barbell"]},
    "tent": {"slug":"tent","label":"テント","emoji":"⛺",
        "kw":"テント おすすめ ソロ キャンプ",
        "desc":"キャンプ用テントの口コミ評価ランキング。実際のキャンパーから高評価を得た一幕。",
        "guide":"設営のしやすさ・耐風性・通気性が三大評価軸。カタログスペックの耐水圧は目安に過ぎず、縫い目の処理やジッパーの耐久性が実際の使用感を左右する。RevRankは楽天購入者の評価点と件数をベイズ補正したスコアで並べる。見た目が映えるモデルより、多くのキャンパーから継続的に高評価を受けたテントを数字で選べるのがRevRankの価値だ。",
        "related":["tarp","outdoor_bedding","camp_chair"]},
    "tarp": {"slug":"tarp","label":"タープ","emoji":"⛺",
        "kw":"タープ おすすめ キャンプ",
        "desc":"タープの口コミ評価ランキング。ヘキサ・レクタ・ウィングなど購入者が評価した製品を紹介。",
        "guide":"設営バリエーションの豊富さ・防水性・収納時のコンパクトさが選択基準。ポリエステル系は軽量でコスパが高く、TC（ポリコットン）素材は結露しにくく焚き火に強い。素材の違いは使ってみないとわかりにくい要素だが、RevRankは評価点と件数のベイズ補正スコアで並べるため、多くのキャンパーから安定して高評価を受けた製品を選べる。",
    ...
    "outdoor_bedding": {"slug":"outdoor-bedding","label":"アウトドア用寝具","emoji":"🏕️",
        ...
        "guide":"快適温度域とカタログ記載の使用可能温度域は異なる。メーカー表記の限界温度より10℃高い環境での使用が現実的な目安。ダウンか化繊か、エア・フォーム・インフレータブルかで用途が変わる。RevRankは評価点と件数をベイズ補正したスコアで順位付けするため、スペックと実際の使用感にギャップのある製品は評価点に反映されやすく、多くの購入者から安定して評価された製品が上位に来る。",
        "related":["tent","tarp"]},
    "camp_chair": {"slug":"camp-chair","label":"キャンプチェア・テーブル","emoji":"🪑",
        "kw":"キャンプ チェア テーブル おすすめ",
        "desc":"キャンプ用チェア・テーブルの口コミ評価ランキング。実際のキャンパーが評価した製品を紹介。",
        "guide":"座り心地・収納サイズ・重量の三点が選択の核心。展開・収納のしやすさや長時間座った後の快適性は使ってみないとわからない。RevRankは評価点と件数をベイズ補正したスコアで並べるため、デザインや話題性ではなく、多くのキャンパーから継続的に高評価を受けた製品が上位に定着する。",
        "related":["tent","bonfire"]},
    "bbq_grill": {"slug":"bbq-grill","label":"バーベキューコンロ","emoji":"🔥",
        "kw":"バーベキューコンロ おすすめ",
        "desc":"バーベキューコンロの口コミ評価ランキング。購入者が評価した製品を比較。",
        "guide":"着火のしやすさ・火力の均一性・後片付けのしやすさが満足度を決める三要素。網の素材（ステンレス vs 鉄製）は耐久性と手入れのしやすさを左右する。RevRankは評価点と件数のベイズ補正スコアで順位付けするため、一度しか使わないユーザーより繰り返し使い続けた購入者の評価が積み上がった製品が上位に来やすい。",
    ...
    "camp_stove": {"slug":"camp-stove","label":"キャンプバーナー","emoji":"🔥",
        ...
        "guide":"火力（出力W）・風への耐性・重量が三大スペック。OD缶対応かCB缶対応かで互換性が変わり、使うシーンを先に想定しておく必要がある。RevRankは購入者の評価点と件数をベイズ補正したスコアで並べる。スペック表だけでは判断できない風防性能や点火の安定性は評価点に反映されやすく、多くの購入者から高評価を受けた製品が上位に浮かび上がる。",
        "related":["bonfire","tent"]},
    "bonfire": {"slug":"bonfire","label":"焚き火台","emoji":"🔥",
        "kw":"焚き火台 おすすめ ソロ",
        "desc":"焚き火台の口コミ評価ランキング。組み立て・収納のしやすさを実際のキャンパーが評価した製品。",
        "guide":"燃焼効率・組み立て・収納のしやすさが選択の核心。ステンレスとチタンでは重量・価格・耐熱性が異なり、用途によって最適解が変わる。RevRankは評価点と件数をベイズ補正したスコアで順位付けするため、繰り返し使い続けた購入者の評価が積み上がった製品が上位に定着する。見た目より実用性で選ぶための数値的な根拠を提供する。",
    ...
    "ski_board": {"slug":"ski","label":"スキー板","emoji":"⛷️",
        ...
        "guide":"フレックス・サイドカットのR値・重量が選択の三軸。初心者はソフトフレックスで扱いやすい板を、中〜上級者はターン性能と安定性のバランスで選ぶ。楽天の売れ筋は入門セットが上位に入りやすいが、RevRankは評価点と件数のベイズ補正スコアで並べ直す。実際にゲレンデで使い続けた購入者から高評価を安定して受けた板が上位に残る。",
    ...
    "ski_boots": {"slug":"ski-boots","label":"スキーブーツ","emoji":"⛷️",
        ...
        "guide":"フィット感・保温性・バックルの調整幅がブーツ選びの肝。同じサイズでもラスト（足型）の幅はメーカーによって大きく異なる。試し履きなしのネット購入は難易度が高いが、RevRankは評価点と件数のベイズ補正スコアで並べるため、多くの購入者から安定して高評価を受けたモデルを起点に選択肢を絞り込める。",
        "related":["ski_board","snowboard_boots"]},
    "snowboard": {"slug":"snowboard","label":"スノーボード","emoji":"🏂",
        "kw":"スノーボード おすすめ 板",
        "desc":"スノーボードの口コミ評価ランキング。購入者が評価した板を紹介。",
        "guide":"フレックス・シェイプ・ワークが板の乗り心地を決める三要素。グラトリ重視ならソフトフレックスのツインチップ、カービング重視ならミディアム以上が基本。楽天の売れ筋はセット商品や入門向けが上位に出やすいが、RevRankは評価点と件数のベイズ補正スコアで並べ直す。多くのライダーから継続的に高評価を受けた板が上位に残る仕組みだ。",
    ...
    "snowboard_boots": {"slug":"snowboard-boots","label":"スノーボードブーツ","emoji":"🏂",
        ...
        "guide":"ヒールホールド・フレックス・防水インナーの品質がブーツの本質。ボードコントロールはブーツとバインディングの連結精度に依存するため、ブーツ選びはライディングスタイルに直結する。RevRankは評価点と件数をベイズ補正したスコアで並べるため、ビジュアルやブランドではなく、多くのスノーボーダーから高評価を受けた製品を根拠をもって選べる。",
    ...
    "mattress": {"slug":"mattress","label":"マットレス","emoji":"🛏️",
        ...
        "guide":"腰への影響・通気性・耐久性が長期的な満足度を決める。高反発・低反発・ポケットコイルそれぞれに合う体型と寝姿勢がある。RevRankは評価点と件数のベイズ補正スコアで順位付けする。購入直後は高評価になりやすいが、件数が積み上がるにつれスコアが実態を反映するため、多くの購入者から継続して高評価を受けた製品が上位に定着する。",
    ...
    "bed_frame": {"slug":"bed-frame","label":"ベッドフレーム","emoji":"🛌",
        ...
        "guide":"組み立てやすさ・軋み音のなさ・耐荷重が選択の核心。組み立て難易度や経年劣化は使ってみないとわからない要素だが、RevRankは評価点と件数をベイズ補正したスコアで並べる。少数レビューはジャンル平均に引き寄せられる仕組みのため、多くの購入者から安定して高評価を受けた製品だけが上位に残る。",
    ...
    "leg_mattress": {"slug":"leg-mattress","label":"脚付きマットレス","emoji":"🛌",
        ...
        "guide":"一人暮らしに選ばれる理由は「搬入のしやすさ」と「ベッドフレーム不要の手軽さ」。脚の安定性・マットレス本体の硬さ・張り地の耐久性が長期的な満足度を左右する。RevRankは評価点と件数のベイズ補正スコアで並べるため、購入後に評価が落ちやすい製品は自然と順位が下がり、安定して高評価を維持している製品が上位に残る。",
        "related":["mattress","bed_frame"]},
    "stroller": {"slug":"stroller","label":"ベビーカー","emoji":"👶",
        "kw":"ベビーカー おすすめ 軽量",
        "desc":"ベビーカーの口コミ評価ランキング。実際のパパ・ママが評価した製品を紹介。",
        "guide":"走行性・折りたたみの手軽さ・収納バスケットの使いやすさが毎日の使用感を決める。段差や改札、エレベーターなど都市での実用性は実際に使ってみないとわからない。RevRankは評価点と件数をベイズ補正したスコアで並べるため、カタログスペックではなく、多くの保護者から継続的に高評価を受けた製品が上位に浮かび上がる。",
        "related":["child_seat"]},
    "child_seat": {"slug":"child-seat","label":"チャイルドシート","emoji":"🚗",
        "kw":"チャイルドシート おすすめ 新生児",
        "desc":"チャイルドシートの口コミ評価ランキング。安全性・使いやすさを購入者が評価した製品を比較。",
        "guide":"安全性能（R129/R44適合）・取り付けのしやすさ・子どもの乗り心地の三点が最重要。ISOFIXと通常ベルト固定の違い、回転式かどうかも選択基準になる。RevRankは評価点と件数のベイズ補正スコアで並べる。命に関わる道具だからこそ、多くの保護者から安定して高評価を受けている製品を数字的な根拠をもって選べることに価値がある。",
        "related":["stroller"]},
    "climbing_shoes": {"slug":"climbing-shoes","label":"登山・クライミングシューズ","emoji":"🧗",
        ...
        "guide":"ダウントゥ（つま先の下がり）・ラバーのスティッキー性・ヒールカップのフィット感が選択の三軸。スラブ系と垂壁・オーバーハング系でも最適なシューズは変わる。試し履きなしのネット購入が多いジャンルだが、RevRankは評価点と件数のベイズ補正スコアで並べるため、多くのクライマーから安定して高評価を受けたモデルを起点に選択を絞り込める。",
        "related":["tent","outdoor_bedding"]},
    "e_bike": {"slug":"e-bike","label":"電動アシスト自転車","emoji":"🚲",
        "kw":"電動アシスト自転車 おすすめ",
        "desc":"電動アシスト自転車の口コミ評価ランキング。通勤・子乗せ・折りたたみなど購入者が評価した一台。",
        "guide":"アシスト力・バッテリー航続距離・車体重量が三大選択基準。坂道の多い地域・通勤距離・駐輪スペースによって最適なモデルは変わる。RevRankは評価点と件数のベイズ補正スコアで並べる。カタログスペックと実際の使用感にギャップがある場合は評価点に反映されやすいため、多くの購入者から安定して高評価を受けた製品が上位に残る。",
        "related":["treadmill","fitness_bike"]},
}
...
.disclosure{max-width:800px;margin:0 auto;padding:6px 0}
.disclosure-inner{display:flex;align-items:center;gap:8px;font-size:11px;color:var(--ink3)}
.disclosure-pr{font-size:9px;font-weight:900;letter-spacing:.08em;border:1px solid currentColor;border-radius:3px;padding:1px 4px;flex-shrink:0}
...
<div class="disclosure"><div class="disclosure-inner"><span class="disclosure-pr">PR</span>本ページの商品リンクには楽天アフィリエイトリンクが含まれます。</div></div>
